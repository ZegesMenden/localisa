...
; base instructions
#ruledef {
	add  r{reg_a:u3} r{reg_b:u3} r{reg_c:u3}		=> 0x0 @ reg_a @ reg_b @ 0b000 @ reg_c
	adc  r{reg_a:u3} r{reg_b:u3} r{reg_c:u3}		=> 0x0 @ reg_a @ reg_b @ 0b001 @ reg_c
	sub  r{reg_a:u3} r{reg_b:u3} r{reg_c:u3}		=> 0x0 @ reg_a @ reg_b @ 0b010 @ reg_c
	subc r{reg_a:u3} r{reg_b:u3} r{reg_c:u3}		=> 0x0 @ reg_a @ reg_b @ 0b011 @ reg_c
	nand r{reg_a:u3} r{reg_b:u3} r{reg_c:u3} 		=> 0x0 @ reg_a @ reg_b @ 0b100 @ reg_c
	and	 r{reg_a:u3} r{reg_b:u3} r{reg_c:u3} 		=> 0x0 @ reg_a @ reg_b @ 0b101 @ reg_c
	or	 r{reg_a:u3} r{reg_b:u3} r{reg_c:u3} 		=> 0x0 @ reg_a @ reg_b @ 0b110 @ reg_c
	xor	 r{reg_a:u3} r{reg_b:u3} r{reg_c:u3} 		=> 0x0 @ reg_a @ reg_b @ 0b111 @ reg_c
	addi r{reg_a:u3} r{reg_b:u3} i{imm:i6}  		=> 0x1 @ reg_a @ reg_b @ imm
	bs	 r{reg_a:u3} r{reg_b:u3} i{imm:u6}			=> 0x2 @ reg_a @ reg_b @ imm
	sw	 r{reg_a:u3} r{reg_b:u3} i{imm:s6} 			=> 0x3 @ reg_a @ reg_b @ imm
	lw	 r{reg_a:u3} r{reg_b:u3} i{imm:s6}			=> 0x4 @ reg_a @ reg_b @ imm
	cmp	 r{reg_a:u3} r{reg_b:u3}					=> 0x5 @ reg_a @ reg_b @ 0b000000
	jalr r{reg_a:u3} r{reg_b:u3}					=> 0x6 @ reg_a @ reg_b @ 0b000000
	beq	 r{reg_a:u3} r{reg_b:u3} i{imm:s6}			=> 0x7 @ reg_a @ reg_b @ imm
	bgr	 r{reg_a:u3} r{reg_b:u3} i{imm:s6}			=> 0x8 @ reg_a @ reg_b @ imm
	mov  r{reg_a:u3} r{reg_b:u3}					=> 0x9 @ reg_a @ reg_b @ 0b000000
	lui  r{reg_a:u3} i{imm: i10}					=> 0b111 @ reg_a @ imm
}
...
cvc
	...
	movi r{reg_a:u3} i{imm:i16} => asm {
		lui r reg_a i (imm>>6)`10
